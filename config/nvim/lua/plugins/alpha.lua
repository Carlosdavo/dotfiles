return {
  ...
  config = function()
    ...
    dashboard.section.buttons.val = {
      dashboard.button("n", "󰈙   New file", ":enew<CR>"),
      dashboard.button("f", "   Find file", ":lua require('fzf-lua').files()<CR>"),
      dashboard.button("w", "󰱼   Find word", ":lua require('fzf-lua').live_grep()<CR>"),
      dashboard.button("r", "   Recent", ":lua Snacks.dashboard.pick('oldfiles')<CR>"),
      dashboard.button("c", "   Config", ":lua Snacks.picker.files({ cwd = '~/.config/nvim/' })<CR>"),
      dashboard.button("l", "󰒲   Lazy", ":Lazy<CR>"),
      dashboard.button("x", "󰆧   Extras", ":LazyExtras<CR>"),
